...
class CashierWindow(BoxLayout):
	...
	def update_purchases(self):
		...
		if code == "1234":
			...
			disc = Label(text='0.0', size_hint_x=.1, color=(.06, .45, .45, 1))
			price = Label(text='0.0', size_hint_x=.1, color=(.06, .45, .45, 1))
			total = Label(text='0.0', size_hint_x=.2, color=(.06, .45, .45, 1))
